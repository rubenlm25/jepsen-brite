...
if (isset($_POST['addevent']) ){
    ...
    function send_data($title, $author, $date_time, $description, $category, $image_tmp_name, $image_type,$sous_category)
    {
        $bdd =
        ...
        $request = $bdd -> prepare("INSERT INTO event(title, author, date_time, description, image, image_type,category,sous_category) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
        $request -> execute(array($title, $author, $date_time, $description, $image_tmp_name, $image_type,$category,$sous_category));
    ...
    if ($image_type === $allowed_filetypes[0])
    {
        ...
        send_data($title, $author, $date_time, $description, $category,  $image_tmp_name, $image_type,$sous_category);	}
